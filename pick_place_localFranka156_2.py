...
salt = XFormPrim("/World/Vegetable_9")
bowl = XFormPrim("/World/CuttingBoard_4")
...
pick_yaw_deg  = 210   # 抓取阶段的 yaw 角度
place_yaw_deg = 270   # 放置阶段的 yaw 角度
...
def step_once(render: bool = True) -> bool:
    ...
    if my_world.is_playing():
        ...
        picking_position = salt_pos + np.array([0.00, 0.00, -0.02])
        placing_position = bowl_pos + np.array([0.00, 0.00, 0.08])
